...
<body>
    ...
    <div class="form-background">
      <div class="form-container">
        ...
        <form method="POST" action="lihat_laporan.php">
          <label for="judul">Ketik judul laporan Anda:</label>
          <input type="text" id="judul" name="judul" required>
      
          <label for="isi">Ketik isi laporan Anda:</label>
          ...
          <label for="lokasi">Ketik lokasi Anda:</label>
  ...
  <header class="header">
    <a href="index.php" class="logo">PENORAK</a>
    <nav class="navbar">
  ...
  <footer id="footer">
    <div class="footer-content">
      ...
      <div class="social-media">
        ...
        <ul>
          <li><a href="https://www.instagram.com/"><img src="instagram-logo.png" width="35"></a></li>
          <li><a id="github-logo" href="https://github.com/"><img src="github-logo.png" width="35"></a></li>
          <li><a href="https://www.linkedin.com/"><img src="linkedin-logo.png" width="35"></a></li>
        </ul>
      </div>
    </div>
    <div class="copyright">
  ...
  <script>
    ...
    function disableDarkMode() {
      ...
      imageContainer.style.backgroundImage = 'url("background.jpg")';
      const inputs = document.querySelectorAll('input[type="text"], input[type="date"], textarea, input[type="email"]');
      for (let i = 0; i < inputs.length; i++) {
